...
<div class="pd-20" style="margin-top: -25px;">
  <form action="${ctx}/employee/addEmployee.action" method="post" class="form form-horizontal" id="generalFormId">
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>员工名：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text"  onblur="checkUniqueness(this,'${ctx}/employee/checkUniqueness.action','','员工名称重复!')"  placeholder="请输入员工姓名" id="v7EName" name="v7EName" datatype="*2-16" nullmsg="员工名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" placeholder="请输入员工真实" id="" name="v7ERealName" datatype="*2-16" nullmsg="员工名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
    ...
    <div class="formControls col-5 skin-minimal">
        <div class="radio-box">
          <input calss="sex"  type="radio" name="v7ESex" datatype="num" value="1" nullmsg="请选择性别！ ">
          <label for="sex-1">男</label>
        </div>
        <div class="radio-box">
          <input calss="sex" type="radio" name="v7ESex"  datatype="num"  value ="2" nullmsg="请选择性别！">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text"  placeholder="请输入员工手机号" id="v7EPhone" name="v7EPhone"  datatype="m" nullmsg="手机不能为空"
        	 onblur="checkUniqueness(this,'${ctx}/employee/checkUniquenessPhone.action','','员工电话号码重复!')"
        >
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
     ...
     <div class="row cl">
      ...
      <div class="formControls col-5">
      <input type="text" class="input-text"  placeholder="输入入职时间" id="" name="v7EJoinDate" value=""
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <textarea name="v7ERemarks" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" ></textarea>
