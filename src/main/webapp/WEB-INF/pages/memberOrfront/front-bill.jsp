...
<body>
	...
	<div class="pd-20" style="margin-top:-14px;">
		...
		<!-- 隐藏信息 -->
		<!-- 会员ID -->
		<input type="hidden" name="v7RMemberid" value="${memberInfo.id }"/>
		<!-- 使用会员卡ID -->
		<input type="hidden" name="v7RCardid" id="v7RCardid" />
		<!-- 使用会员卡类型 -->
		<input type="hidden" name="v7RUsecardtype" id="v7RUsecardtype" />
		...
		<div class="text-c">
				...
				<table>
					<tr>
						...
						<td id="consumption_td" style="padding:5px;  text-align:left;">
							<span id="vipSpan"> <input type="radio" name="v7RConsumption" value="1" onclick="consumptionFun(1)"/>&nbsp;VIP卡</span>
	                        <span id="hedgingSpan">&nbsp;<input type="radio" name="v7RConsumption" value="2" onclick="consumptionFun(2)"/> &nbsp;对冲卡</span>
	                        <span id="blowWashSpan">&nbsp;<input type="radio" name="v7RConsumption" value="3" onclick="consumptionFun(3)"/> &nbsp;洗吹卡</span>
	                        <span id="blowCutWashSpan">&nbsp;<input type="radio" name="v7RConsumption" value="4" onclick="consumptionFun(4)"/> &nbsp;洗剪吹卡</span>
	                        <span id="cashSpan">&nbsp;<input type="radio" name="v7RConsumption" value="5" onclick="consumptionFun(5)"/> &nbsp;现金</span>
						</td>
						
						<td style="padding:5px;  text-align:right;" >消费类型&nbsp;</td>
						<td style="padding:5px;  text-align:left;">
							<select name="v7RConsumetype" id="v7RConsumetype" onchange="changeInable(this)" class="select select-width">
					...
					<tr>
						...
						<td style="padding:5px; text-align:left;">
							<select name="v7RPermcostprice" id="perm" class="select select-width">
								<option value="-1">请选择</option>
						...
						<td style="padding:5px;  text-align:left;">
							<select name="v7RDyehaircostprice" id="dyeHair" class="select select-width">
								<option value="-1">请选择</option>
						...
						<td style="padding:5px;  text-align:left;">
							<select name="v7RConditionercostprice"  id="conditioner" class="select select-width">
								<option value="-1">请选择</option>
					...
					<tr>
						...
						<td style="padding:5px; text-align:left;">
							<select name="v7RHairstylist" id="v7RHairstylist" onchange="computeData()" class="select select-width">
								<option value="-1">请选择</option>
						...
						<td style="padding:5px;  text-align:left;">
							<select name="v7RTechnician" id="v7RTechnician"  class="select select-width">
								<option value="-1">请选择</option>
						...
						<td style="padding:5px;  text-align:left;">
							<select name="v7RAssistant" id ="v7RAssistant" class="select select-width">
								<option value="-1">请选择</option>
				...
				<div id="vipdiv">
					<table>
						<tr id="vipdiv_systemDiscount_tr">
							...
							<td style="padding:5px;"><input type="text" name="v7RSumcostprice" placeholder="消费原价" readonly="readonly" class="input-text"></td>
							<td style="padding:5px; text-align: right;" >折后价&nbsp;</td>
							<td style="padding:5px;"><input type="text" name="v7RDiscountprice"  placeholder="消费折后价" readonly="readonly" class="input-text"></td>
							<td style="padding:5px; text-align: right;">加价产品&nbsp;</td>
							<td style="padding:5px; text-align: left;">
								<select  name="v7RRaiseamount"   class="select select-width" size="1">
									<option value="-1">请选择</option>
									<c:forEach items="${raiseAmount }" var="raiseAmount">
										<option value="${raiseAmount.key}" >${raiseAmount.value }</option>
									</c:forEach>
								</select>
							</td>
						</tr>
				...
				<div id="hedgingdiv">
					<table>
						<tr id="hedgingdiv_systemDiscount_tr">
							...
							<td style="padding:5px;"><input type="text" name="v7RPaycash4hedging" placeholder="付现金额" readonly="readonly" class="input-text"></td>
							<td style="padding:5px; text-align: right;">加价产品&nbsp;</td>
							<td style="padding:5px; text-align: left;">
								<select  name="v7RRaiseamount"  class="select select-width" size="1" >
									<option value="-1">请选择</option>
				...
				<div id="recorddiv">
					<table>
						<tr id="recorddiv_systemDiscount_tr">
							...
							<td style="padding:5px;"><input type="text" name="v7RRecordnum" id="v7RRecordnum" placeholder="划卡次数" class="input-text"></td>
							<td style="padding:5px; text-align: right;">加价产品&nbsp;</td>
							<td style="padding:5px; text-align: left;">
								<select name="v7RRaiseamount" class="select select-width" size="1">
									<option value="-1">请选择</option>
				...
				<div id="cashdiv">
					<table>
						<tr id="vipdiv_CustomDiscount_tr">
							<td style="padding:5px;">原价&nbsp;</td>
							<td style="padding:5px;"><input type="text" name="v7RSumcostprice" id="v7RSumcostprice"  placeholder="消费原价" readonly="readonly"  class="input-text"></td>
							<td style="padding:5px; text-align: right;" >折扣率&nbsp;</td>
							<td style="padding:5px;"><input type="text" name="v7RDiscountrate" id="v7RDiscountrate" placeholder="消费折扣率" onblur="computeData4Cash()"  class="input-text"></td>
							<td style="padding:5px; text-align: right;" >折后价&nbsp;</td>
							<td style="padding:5px;"><input type="text" name="v7RDiscountprice" id="v7RDiscountprice"  placeholder="折后价" class="input-text"></td>
							<td style="padding:5px; text-align: right;">加价产品&nbsp;</td>
							<td style="padding:5px; text-align: left;">
								<select  name="v7RRaiseamount"  class="select select-width" size="1">
									<option value="-1">请选择</option>
			...
			<!-- 产品信息 -->
			<div class="text-c" id="productDiv" >
				...
				<table>
					<tr>
						...
						<td style="padding:5px; text-align: left;" >
							<select name="v7RProductid" id="prodictChange"  class="select select-width" size="1" onchange="selectMaxInPrice()">
								<option value="-1">请选择</option>
					...
					<tr>
						...
						<td style="padding:5px; text-align: left;">
							<select name="v7RSaleUser" id="v7RSaleUser"   class="select select-width" size="1">
								<option value="-1">请选择</option>
						...
						<td style="padding:5px; text-align: left;"><input type="text" id="v7RSaleProammount" name="v7RSaleProammount"  placeholder=" 请输入消费金额"  class="input-text"></td>
						<td style="padding:5px; text-align: right;">销售数量&nbsp;</td>
						<td style="padding:5px; text-align: left;"><input type="text" id="v7RSaleCount" name="v7RSaleCount"  placeholder=" 请输入消费金额"  class="input-text"></td>
					</tr>
				</table>
			</div>
...
$(function(){
	...
	if(success != ''){
		 layer.msg('结单成功！',{icon:6,time:2500});
	}
	
	var nullCheck = '${nullData}';
	if('nullData' == nullCheck){
		layer.msg('系统未检索到会员数据，请核实查询条件!',{icon:5,time:3000});
	}
	...
	if('' == memberInfo){
		...
		$("input[type='radio'][name=v7RConsumption][value='5']").attr("checked",true);
	}else{
		/**非现金结账*/
		$("#memberInfoDiv").show();
		$("#cashSpan").hide();
		...
		if((tempArray.length -1)   == 1){
			...
			if(tempSingle == '金卡' || tempSingle == '银卡' || tempSingle == '普卡' ){
				$("input[type='radio'][name=v7RConsumption][value='1']").attr("checked",true);
				$("#vipdiv").show();
			}
			if(tempSingle == '对冲卡'){
				$("input[type='radio'][name=v7RConsumption][value='2']").attr("checked",true);
				$("#hedgingdiv").show();
			}
			if(tempSingle == '洗吹卡'){
				$("input[type='radio'][name=v7RConsumption][value='3']").attr("checked",true);
				$("#recorddiv").show();
			}
			if(tempSingle == '洗剪吹卡'){
				$("input[type='radio'][name=v7RConsumption][value='4']").attr("checked",true);
				$("#recorddiv").show();
			}
			//给隐藏域中的会员使用默认的会员卡赋值
			$("#v7RCardid").val('${memberInfo.memberCard[0].id}');
			//给隐藏域中的会员使用默认的会员卡类型赋值
			$("#v7RUsecardtype").val('${memberInfo.memberCard[0].v7CType}');
		} 
	}
...
function changeInable(){
	//消费方式是否确认
	 var consumptionVal = $("input[type='radio'][name=v7RConsumption]:checked ").val(); //消费方式
	 if(consumptionVal == undefined){
		 layer.msg('请先选择消费方式！',{icon:5,time:2000});
		 return;
	 }
	 clearDate();
	
	var temp = $("#v7RConsumetype").find("option:selected").val();
	if(temp == 1 || temp == 2 ){
		$("#perm").attr("disabled",true);  
		$("#dyeHair").attr("disabled",true);  
		$("#conditioner").attr("disabled",true);  
...
function consumptionFun(consumptionType){
	//清空数据
	clearDate();
	var v7RConsumetype = document.getElementById("v7RConsumetype");v7RConsumetype.options[0].selected = true;
	$("#productDiv").show();
	if("5" == consumptionType){  //现金
		...
		$("#vipdiv").hide(); 
		$("#recorddiv").hide(); 
		$("#v7RConsumetype").attr("readonly",false);  
	}else if("4" == consumptionType){ //洗剪吹
		$("#recorddiv").show(); 
		$("#cashdiv").hide(); 
		$("#hedgingdiv").hide(); 
		$("#vipdiv").hide();
		$("#v7RCardid").val($("#vip_record4BlowCutWash_id_hidden").val());
		$("#v7RUsecardtype").val($("#useCardType4BlowCutWash").val());
		
		var v7RConsumetype = document.getElementById("v7RConsumetype");v7RConsumetype.options[2].selected = true;
		$("#v7RConsumetype").attr("readonly",true);  
		...
		$("#hedgingdiv").hide(); 
		$("#vipdiv").hide();
		$("#v7RCardid").val($("#vip_record4BlowWash_id_hidden").val());
		$("#v7RUsecardtype").val($("#useCardType4blowWash").val());
		
		var v7RConsumetype = document.getElementById("v7RConsumetype");v7RConsumetype.options[1].selected = true;
		$("#v7RConsumetype").attr("readonly",true); 
		...
		$("#hedgingdiv").show(); 
		$("#vipdiv").hide();
		$("#v7RCardid").val($("#vip_hedgingCard_id_hidden").val());
		$("#v7RUsecardtype").val($("#useCardType4Hedging").val());
		$("#v7RConsumetype").attr("disabled",false);  
	}else if("1" == consumptionType){   //VIP
		$("#recorddiv").hide(); 
		$("#cashdiv").hide(); 
		$("#hedgingdiv").hide(); 
		$("#vipdiv").show();
		$("#v7RCardid").val($("#vip_goldCard_id_hidden").val() != undefined?$("#vip_goldCard_id_hidden").val():$("#vip_silverCard_id_hidden").val() != undefined?$("#vip_silverCard_id_hidden").val():$("#vip_classicCard_id_hidden").val());
		$("#v7RUsecardtype").val($("#useCardType4VIP").val());
		$("#v7RConsumetype").attr("disabled",false);  
	}
...
function clearDate(){
	//清空关联选项中的数据
	var hairstylist = document.getElementById("v7RHairstylist");hairstylist.options[0].selected = true;
	var technician = document.getElementById("v7RTechnician");technician.options[0].selected = true;
	var assistant = document.getElementById("v7RAssistant");assistant.options[0].selected = true;
	...
	//原价，折后价，应付现，划卡次数
	$("input[name='v7RSumcostprice']").each(function (){
			$(this).attr('value',"");
	}); 
	$("input[name='v7RDiscountprice']").each(function (){
		$(this).attr('value','');
	}); 
	$("input[name='v7RPaycash4hedging']").each(function (){
		$(this).attr('value','');
	}); 
	$("input[name='v7RRecordnum']").each(function (){
		$(this).attr('value','');
	}); 
}
	...
	$.ajax({
	    ...
	    success: function( data ) {
	    	if(data.count == undefined){
	    		 layer.msg("该产品下没能检索到数据~",{icon:5,time:3000});
...
function computeData(){
	...
	if(temp == 1 ){
		...
		var baseValue = $("#v7RHairstylist").find("option:selected").text();
...
function computeDiscountPrice(blowWashCostPrice,blowCutWashCostPrice,permCostPrice,dyeHairCostPrice,conditionerCostPrice){
	var useCardType = $("#v7RUsecardtype").val();
	
	if(useCardType ==1){//金卡
		var consumeType = $("#v7RConsumetype").find("option:selected").val();
		if(consumeType == 1){ //洗吹
 ...
 function layerOpen(){
	 layer.msg('数据填写不全！',{icon:5,time:2000});
 }
 ...
 /**根据折扣率和原价计算折后价*/
 function computeData4Cash(){
	 var v7RSumcostprice = $("#v7RSumcostprice").val();
	 var v7RDiscountrate = $("#v7RDiscountrate").val();
	
	 var temp = (parseFloat(v7RSumcostprice)*parseFloat(v7RDiscountrate)).toFixed(2);
	 $("input[name='v7RDiscountprice']").each(function (){
 ...
 function checkCashier(){
	 ...
	 var hairstylist = $("#v7RHairstylist").find("option:selected").val();  //发型师
	 if(hairstylist == -1){warning += "发型师不能为空！<br/>"}
	 var technician = $("#v7RTechnician").find("option:selected").val();    //技师
	 if(technician == -1){warning += "技师不能为空！<br/>"}
	 var consumeType = $("#v7RConsumetype").find("option:selected").val();  //消费类型
	 ...
	 if(3 == consumptionVal || 4 == consumptionVal ){
		var temp = $("#v7RRecordnum").val();
		if(temp == ""){warning +="划卡次数不能为空！<br/>"}
	 }
	 
	 var prodictChange = $("#prodictChange").find("option:selected").val();
	 if('-1' != prodictChange){
		 var v7RSaleUser = $("#v7RSaleUser").find("option:selected").val();
		 if('-1' ==  v7RSaleUser){warning +="产品销售人不能为空！<br/>";}
		 var v7RSaleProammount = $("#v7RSaleProammount").val();
		 if('' == v7RSaleProammount){warning +="产品销售价格不能为空！<br/>";}
		 var v7RSaleCount = $("#v7RSaleCount").val();
		 if('' == v7RSaleCount){warning +="产品销售数量不能为空!<br/>"}
	 }
